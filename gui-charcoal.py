...
Tema escuro inspirado no GNS3 Charcoal.
"""
...
class NmapGUI(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Nmap GUI — GNS3 Charcoal Theme")
    ...
    def _build_ui(self):
        ...
        self.scan_btn.setObjectName("scanButton")   # para estilo especial
...
def main():
    ...
    # Aplica o tema Charcoal
    app.setStyle("Fusion")          # base limpa para o QSS funcionar bem
    app.setStyleSheet(CHARCOAL_STYLE)
